...
namespace SnakeGame
{
    ...
    /// Contains getters and setters for snake id, snake name, location of body,
    /// direction of snakes body, score of snake, died, alive, disconnected, joined and Json contructor.
    /// </summary>
    public class Snake
    {
        /// <summary>
